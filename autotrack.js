 ...
 * @return {number}
 */
var rIC = supportsRequestIdleCallback_ ? requestIdleCallback : requestIdleCallbackShim;
 ...
 * @param {number} handle
 */
var cIC = supportsRequestIdleCallback_ ? cancelIdleCallback : cancelIdleCallbackShim;
 ...
 */
var queueMicrotask = typeof Promise === 'function' && Promise.toString().indexOf('[native code]') > -1 ? createQueueMicrotaskViaPromises() : createQueueMicrotaskViaMutationObserver();
...
var isSafari_ = !!((typeof safari === 'undefined' ? 'undefined' : _typeof(safari)) === 'object' && safari.pushNotification);
...
var IdleQueue = function () {
  ...
  function IdleQueue() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        ensureTasksRun = _ref$ensureTasksRun === undefined ? false : _ref$ensureTasksRun,
        _ref$defaultMinTaskTi = _ref.defaultMinTaskTime,
        defaultMinTaskTime = _ref$defaultMinTaskTi === undefined ? DEFAULT_MIN_TASK_TIME : _ref$defaultMinTaskTi;
  ...
  createClass(IdleQueue, [{
    ...
    value: function addTask_(arrayMethod, task) {
      var _ref2 = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
          ...
          minTaskTime = _ref2$minTaskTime === undefined ? this.defaultMinTaskTime_ : _ref2$minTaskTime;
    ...
    value: function runTasks_() {
      var deadline = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
...
var TrackerQueue = function (_IdleQueue) {
  ...
  function TrackerQueue(trackingId) {
    ...
    var _this = possibleConstructorReturn(this, (TrackerQueue.__proto__ || Object.getPrototypeOf(TrackerQueue)).call(this, { defaultMinTaskTime: 25, ensureTasksRun: true }));
  ...
  createClass(TrackerQueue, [{
    ...
    value: function destroy() {
      ...
      if (instances$1[this.trackingId_].references === 0) {
        get(TrackerQueue.prototype.__proto__ || Object.getPrototypeOf(TrackerQueue.prototype), 'destroy', this).call(this);
  ...
  createClass(EventTracker, [{
    ...
    value: function handleEvents(event, element) {
      ...
      this.queue.pushTask(function (_ref) {
        ...
        _this2.tracker.send(hitType, createFieldsObj(defaultFields, userFields, _this2.tracker, _this2.opts.hitFilter, element, event));
      });
    }
  ...
  createClass(ImpressionTracker, [{
    ...
    value: function observeElements(elements) {
      ...
      this.queue.pushTask(function () {
        ...
        _this2.thresholdMap = assign({}, data.thresholdMap, _this2.thresholdMap);
        ...
        if (!_this2.mutationObserver) {
          _this2.mutationObserver = new MutationObserver(_this2.handleDomMutations);
    ...
    value: function deriveDataFromElements(elements) {
      ...
      if (elements.length) {
        elements.forEach(function (element) {
          ...
          thresholdMap[item.threshold] = _this5.thresholdMap[item.threshold] || null;
        });
      }
    ...
    value: function handleImpression(_ref2) {
      ...
      this.queue.pushTask(function () {
        ...
        /** @type {FieldsObj} */
        var userFields = assign({}, _this7.opts.fieldsObj, getAttributeFields(element, _this7.opts.attributePrefix));

        _this7.tracker.send('event', createFieldsObj(defaultFields, userFields, _this7.tracker, _this7.opts.hitFilter, element));
      });
    }
...
var IdleValue = function () {
  ...
  createClass(IdleValue, [{
    ...
    value: function setValue() {
      var newValue = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.init_();
  ...
  createClass(Store, [{
    ...
    value: function update(newData) {
      ...
      if (timestampKey && typeof newData[timestampKey] === 'number') {
        oldData = this.read_() || {};
        if (typeof oldData[timestampKey] === 'number' && oldData[timestampKey] > newData[timestampKey]) {
          return;
        }
      } else {
        oldData = this.data;
  ...
  createClass(Session, [{
    ...
    value: function datesAreDifferentInTimezone(d1, d2) {
      if (this.dateTimeFormatter_) {
        return this.dateTimeFormatter_.format(d1) != this.dateTimeFormatter_.format(d2);
      } else {
        return false;
      }
    }
    ...
    value: function sendHitTaskOverride(originalMethod) {
      ...
      return function (model) {
        ...
        var sessionWillStart = sessionControl == 'start' || _this2.isExpired();
...
var MaxScrollTracker = function () {
  ...
  createClass(MaxScrollTracker, [{
      ...
      this.queue.pushTask(function (_ref) {
        ...
        if (_this.session.isExpired(_this.store.data.sessionId)) {
          ...
          if (scrollPercentage > maxScrollPercentage) {
            ...
            if (scrollPercentage == 100 || increaseAmount >= _this.opts.increaseThreshold) {
              _this.setMaxScrollPercentageForCurrentPage(scrollPercentage);
              _this.sendMaxScrollEvent(increaseAmount, scrollPercentage, time);
            }
          }
        }
      });
    ...
    value: function sendMaxScrollEvent(increaseAmount, scrollPercentage, scrollTimestamp) {
      var _this3 = this;
      ...
      this.queue.pushTask(function () {
        ...
        if (_this3.opts.maxScrollMetricIndex) {
          defaultFields['metric' + _this3.opts.maxScrollMetricIndex] = increaseAmount;
        }

        _this3.tracker.send('event', createFieldsObj(defaultFields, _this3.opts.fieldsObj, _this3.tracker, _this3.opts.hitFilter));
      });
    }
    ...
    value: function setMaxScrollPercentageForCurrentPage(maxScrollPercentage) {
      ...
      this.store.update((_store$update = {}, defineProperty(_store$update, this.pagePath, maxScrollPercentage), defineProperty(_store$update, 'sessionId', this.session.id), _store$update));
    }
  ...
  createClass(MediaQueryTracker, [{
    ...
    value: function handleChanges(definition) {
      ...
      if (newValue !== oldValue) {
        ...
        this.sendChangeEvent({ definition: definition, oldValue: oldValue, newValue: newValue });
      }
    }
  ...
  createClass(OutboundFormTracker, [{
    ...
    value: function handleFormSubmits(event, form) {
      ...
      if (this.opts.shouldTrackOutboundForm(form, parseUrl)) {
        ...
        this.tracker.send('event', createFieldsObj(defaultFields, userFields, this.tracker, this.opts.hitFilter, form, event));
      }
    }
...
var isSafari_$1 = !!((typeof safari === 'undefined' ? 'undefined' : _typeof(safari)) === 'object' && safari.pushNotification);
...
var PageVisibilityTracker = function () {
  ...
  function PageVisibilityTracker(tracker, opts) {
    ...
    this.store = Store.getOrCreate(trackingId, 'plugins/page-visibility-tracker', { timestampKey: 'time' });
  ...
  createClass(PageVisibilityTracker, [{
    ...
    value: function handleChange() {
      ...
      this.queue.pushTask(function (_ref2) {
        ...
        if (_this.session.isExpired(lastStoredChange.sessionId)) {
          ...
          if (_this.lastPageVisibilityState == HIDDEN && visibilityState == VISIBLE) {
            ...
            _this.visibleThresholdTimeout_ = setTimeout(function () {
              ...
              _this.sendPageview({ pageviewTime: time, sessionDidExpire: true });
          ...
          if (visibilityState == VISIBLE && _this.opts.sendInitialPageview && !_this.isInitialPageviewSent_) {
            _this.sendPageview({ pageviewTime: time });
            _this.isInitialPageviewSent_ = true;
          } else if (lastStoredChange.pageId == PAGE_ID && lastStoredChange.state == VISIBLE) {
    ...
    value: function getAndValidateChangeData() {
      ...
      if (this.lastPageVisibilityState == VISIBLE && lastStoredChange.state == HIDDEN && lastStoredChange.pageId != PAGE_ID) {
      ...
      if (delta && delta >= this.opts.visibleThreshold) {
        ...
        this.queue.pushTask(function () {
          ...
          if (_this2.opts.visibleMetricIndex) {
            defaultFields['metric' + _this2.opts.visibleMetricIndex] = deltaInSeconds;
          }

          _this2.tracker.send('event', createFieldsObj(defaultFields, _this2.opts.fieldsObj, _this2.tracker, _this2.opts.hitFilter));
        });
      }
    }
    ...
    value: function sendPageLoad(_ref4) {
      ...
      this.queue.pushTask(function () {
        ...
        var defaultFields = (_defaultFields = {
          ...
          eventLabel: NULL_DIMENSION
        }, defineProperty(_defaultFields, 'metric' + _this3.opts.pageLoadsMetricIndex, 1), defineProperty(_defaultFields, 'nonInteraction', true), defineProperty(_defaultFields, 'queueTime', pageLoadTime ? now() - pageLoadTime : undefined), _defaultFields);
    ...
    value: function sendPageview(_ref5) {
      ...
      this.queue.pushTask(function () {
        ...
        _this4.tracker.send('pageview', createFieldsObj(defaultFields, _this4.opts.fieldsObj, _this4.tracker, _this4.opts.hitFilter));
  ...
  createClass(SocialWidgetTracker, [{
    ...
    value: function handleTweetEvents(event) {
      ...
      this.queue.pushTask(function (_ref) {
        ...
        _this4.tracker.send('social', createFieldsObj(defaultFields, _this4.opts.fieldsObj, _this4.tracker, _this4.opts.hitFilter, event.target, event));
      });
    }
    ...
    value: function handleFollowEvents(event) {
      ...
      this.queue.pushTask(function (_ref2) {
        ...
        _this5.tracker.send('social', createFieldsObj(defaultFields, _this5.opts.fieldsObj, _this5.tracker, _this5.opts.hitFilter, event.target, event));
      });
    }
    ...
    value: function handleLikeEvents(url) {
      ...
      this.queue.pushTask(function (_ref3) {
        ...
        _this6.tracker.send('social', createFieldsObj(defaultFields, _this6.opts.fieldsObj, _this6.tracker, _this6.opts.hitFilter));
      });
    }
    ...
    value: function handleUnlikeEvents(url) {
      ...
      this.queue.pushTask(function (_ref4) {
        ...
        _this7.tracker.send('social', createFieldsObj(defaultFields, _this7.opts.fieldsObj, _this7.tracker, _this7.opts.hitFilter));
      });
    }
